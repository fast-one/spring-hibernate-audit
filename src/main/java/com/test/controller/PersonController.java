...
public class PersonController {
	...
	@RequestMapping(value = "/revision/{pid}")
	public String findRevision(ModelMap model, @PathVariable("pid") Long pid)
	{
		model.addAttribute("allData", personService.findRevisions(pid));
